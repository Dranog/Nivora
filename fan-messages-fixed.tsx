  ...
  return (
    <div className="container mx-auto p-4 h-[calc(100vh-4rem)]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
        <Card
          className={`$(selectedConversation ? 'hidden md:block' : 'block') md:col-span-1 overflow-hidden flex flex-col`}
        >
        ...
        <Card
          className={`$(!selectedConversation ? 'hidden md:flex' : 'flex') md:col-span-2 overflow-hidden flex-col`}
        >
