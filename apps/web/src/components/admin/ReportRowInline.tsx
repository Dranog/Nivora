/**
 * ReportRowInline - Inline Report Row Content (F12)
...
export interface ReportRowInlineProps {
  report: AdminReport;
  currentUserId?: string;
}

export function ReportRowInline({ report, currentUserId }: ReportRowInlineProps) {
